...
transform_invoice_line_items_for_ctsit <- function(invoice_line_items) {
  ...
  checkmate::assert_subset(invoice_line_items$`Fiscal Year Paid`, expected_fiscal_years)  #: chr [1:41] "2025-2026" "2025-2026" "2025-2026" "2025-2026" ...
  checkmate::assert_subset(invoice_line_items$`Month Paid`, expected_months)              #: chr [1:41] "August" "August" "August" "August" ...
  ...
  checkmate::assert_subset(invoice_line_items$`Name of Service`, c("Biomedical Informatics Consulting", NA))       #: chr [1:41] "Biomedical Informatics Consulting" "Biomedical Informatics Consulting" "Biomedical Informatics Consulting" "Biomedical Informatics Consulting" ...
  checkmate::assert_numeric(invoice_line_items$`SumOfQty Provided`)                       #: num [1:41] 1 1 1 1 5.75 1 1 1 1 1 ...
  checkmate::assert_numeric(invoice_line_items$`SumOfCost of Service`)                    #: num [1:41] 130 130 260 130 130 130 130 130 130 130 ...
  checkmate::assert_numeric(invoice_line_items$`SumOfAmount Due`)                         #: num [1:41] 130 130 130 130 748 ...
  ...
  checkmate::assert_numeric(invoice_line_items$`Do Not Bill Reason`)                      #: logi [1:41] NA NA NA NA NA NA ...
  ...
  checkmate::assert_posixct(invoice_line_items$`Date of Pmt`)                             #: POSIXct[1:41], format: "2025-08-26" "2025-08-26" "2025-08-26" "2025-08-26" ...
